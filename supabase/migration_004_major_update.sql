...
-- (después de las migraciones 002 y 003). No borra datos de negocio.
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 3) NUEVOS VALORES DE ENUM (deben ejecutarse fuera de una transacción; el
--    editor SQL de Supabase ya ejecuta cada sentencia de forma individual)
-- ----------------------------------------------------------------------------
